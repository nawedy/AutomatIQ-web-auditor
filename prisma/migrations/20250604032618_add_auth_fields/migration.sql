/*
  ...
  - You are about to drop the `audit_categories` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `audit_checks` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `audit_results` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `audit_summaries` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `audits` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `page_audit_results` table. If the table is not empty, all the data it contains will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "public"."audit_checks" DROP CONSTRAINT "audit_checks_category_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."audit_results" DROP CONSTRAINT "audit_results_audit_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."audit_results" DROP CONSTRAINT "audit_results_check_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."audit_summaries" DROP CONSTRAINT "audit_summaries_audit_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."audits" DROP CONSTRAINT "audits_website_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."page_audit_results" DROP CONSTRAINT "page_audit_results_audit_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."page_audit_results" DROP CONSTRAINT "page_audit_results_check_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."page_audit_results" DROP CONSTRAINT "page_audit_results_page_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."pages" DROP CONSTRAINT "pages_website_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."websites" DROP CONSTRAINT "websites_user_id_fkey";

-- DropTable
DROP TABLE "public"."audit_categories";

-- DropTable
DROP TABLE "public"."audit_checks";
...
-- DropTable
DROP TABLE "public"."page_audit_results";
